...
def get_graph_builder(module_map_pattern_path=None, device=0):
    ...
    if _graph_builder is None:
        if module_map_pattern_path is None or module_map_pattern_path == ".":
            module_map_pattern_path = str(Path(__file__).parent / "module_map_ttbar_muon_PtFlat1-100_1-5_1-2_pion_PtFlat_1-5_cleaned_mean_rms_replaced_thr5_tol1e-10")
...
def build_graph(graph, module_map_path=None, device=0):
    ...
    try:
        ...
        # hit_id_t = graph.hit_id
        # hit_module_id_t = graph.hit_module_id
        # hit_x_t = graph.hit_x
        # hit_y_t = graph.hit_y
        # hit_z_t = graph.hit_z
