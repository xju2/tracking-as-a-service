...
from dp_walkthrough import dp_walk_through
...
class MetricLearningInferenceConfig:
    ...
    walk_min: float = 0.1
    walk_max: float = 0.6
    walk_path_metric: str = "score_weighted_length"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", type=str, default="../1", help="Model path")
